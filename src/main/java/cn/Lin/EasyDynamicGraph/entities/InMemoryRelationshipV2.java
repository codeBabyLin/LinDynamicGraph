...
public class InMemoryRelationshipV2 extends InMemoryRelationship {
    ...
    public void merge(InMemoryEntity other) {
        if (other instanceof InMemoryRelationship ) {
            InMemoryRelationship otherRel = (InMemoryRelationship) other;
            ...
            if (other instanceof InMemoryRelationshipV2) {
                InMemoryRelationshipV2 otherRelV2 = (InMemoryRelationshipV2) other;
                copyPointers(otherRelV2);
            }
        } else {
            //throw new InvalidArgumentException(String.format("Cannot merge InMemoryRelationshipV2 with %s", other.toString()));
        }
    }
    ...
    public InMemoryRelationshipV2 copy() {
        InMemoryRelationshipV2 newRel = copyWithoutProperties(this.startTimestamp, this.deleted, this.diff);
    ...
    public InMemoryRelationshipV2 copyWithoutProperties(long timestamp, boolean deleted, boolean diff) {
        InMemoryRelationshipV2 newRel = new InMemoryRelationshipV2(
    ...
    public long getSize() {
        // header + id + timestamp
        int size = Byte.BYTES + Long.BYTES + Long.BYTES;
        // pointers
        size += 4 * Long.BYTES;
    ...
    public static InMemoryRelationshipV2 createCopy(InMemoryRelationship rel) {
        ...
        Property[] props = rel.properties.getProperties();
