...
public class InMemoryRelationship implements InMemoryEntity {
    ...
    public void addProperty(String key, Object value) {
        PropertyType propertyType = PropertyType.getType(value);
    ...
    public void merge(InMemoryEntity other) {
        if (other instanceof InMemoryRelationship) {
            ...
            //throw new InvalidArgumentException(String.format("Cannot merge InMemoryRelationship with %s", other.toString()));
        }
    }
    ...
    public InMemoryRelationship copy() {
        InMemoryRelationship newRel = copyWithoutProperties(this.startTimestamp, this.deleted, this.diff);
