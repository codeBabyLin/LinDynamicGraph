...
import cn.Lin.EasyDynamicGraph.lineageindex.entitystores.disk.PersistentNodeStore;
import cn.Lin.EasyDynamicGraph.lineageindex.entitystores.disk.PersistentRelationStore;
...
public class PersistentLineageStore implements LineageStore {
    ...
    public PersistentLineageStore(){
        this.transformer = new Transformer();
        String nodeStorePath = "./nodeStore";
        String relationStorePath = "./relationStore";
        nodeStore = new PersistentNodeStore(nodeStorePath,transformer);
        relationshipStore = new PersistentRelationStore(relationStorePath,transformer);
    }
    ...
    public void flushIndexes() {
        nodeStore.flushIndex();
        relationshipStore.flushIndexes();
    }
    ...
    public void shutdown() throws IOException {
        nodeStore.shutdown();
        relationshipStore.shutdown();
    }

    public void setDiffThreshold(int threshold) {
        nodeStore.setDiffThreshold(threshold);
        relationshipStore.setDiffThreshold(threshold);
    }
}